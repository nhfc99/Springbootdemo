...
@Data
public class HomeQualityStatisticsForAreaVo {
    ...
    @ApiModelProperty(value = "当前range范围内，以项目分组，缺陷记录数的分类统计")
    public Map<String, HomeQualityStatisticsForAreaProgramsVo> programs;
}
