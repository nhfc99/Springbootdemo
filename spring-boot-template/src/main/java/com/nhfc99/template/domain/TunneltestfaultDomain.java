...
public class TunneltestfaultDomain implements Serializable {
    /**
     * 主键编号
     */
    private String id;
     ...
     */
    public TunneltestfaultDomain(String id, Date createDate, String createUserId, String createUserName, Date lastEditDate, String projectInfoId, String tunnelInfoId, String tunnelTestReportId, Integer startKilometre, BigDecimal startMetre, Integer endKilometre, BigDecimal endMetre, BigDecimal faultLength, String faultType, String faultSite, String designAmount, String actualAmount, String backMemo, Boolean isFault, Boolean isFix, String tunnelFixReportId, Integer faultLevel, Boolean isSendMsg) {
        this.id = id;
