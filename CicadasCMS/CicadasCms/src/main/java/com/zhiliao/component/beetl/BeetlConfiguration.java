...
public class BeetlConfiguration {
	...
	@Bean(name = "function")
	public Map<String, Function> function(PermissionFunction permissionTag, TreePermissionFunction permissionFunction,
			TreeCategoryFunction categoryFunction, SelectCategoryFunction selectCategoryFunction,
			TreeContentCategoryFunction contentCategoryFunction, SelectPermissionFunction selectPermissionOut,
			ContentTreeCategoryFunction contentTreeCategoryFunction,
			ContentSelectCategoryFunction contentSelectCategoryFunction,
			TreeTopicCatagoryFunction treeTopicCatagoryFunction, TreeOrganizationFunction treeOrganizationFunction,
			SelectOrganizationFunction selectOrganizationFunction, OrganizationFunction organizationFunction,
	...
	public BeetlGroupUtilConfiguration getbeetlConfig(@Qualifier("function") Map<String, Function> function,
		...
		try {
			ClasspathResourceLoader classpathResourceLoader = new ClasspathResourceLoader(
					BeetlConfiguration.class.getClassLoader(), "templates/");
...
//            beetlGroupUtilConfiguration.setErrorHandler(new BeetlWebErrorHandler());
	...
	public BeetlSpringViewResolver getBeetlSpringViewResolver(
			@Qualifier(value = "beetlConfig") BeetlGroupUtilConfiguration beetlGroupUtilConfiguration) {
